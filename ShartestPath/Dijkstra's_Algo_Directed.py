"""
Docstring for ShartestPath.Dijkstra's_Algo

Dijkstra's Algorithm implementation for finding the shortest path in a weighted graph using an adjacency matrix.
...
3. Update the distances to adjacent vertices if a shorter path is found through the current vertex.
