...
def firstBadVersion(n):
    ...
    while l < r:
        ...
        if isBadVersion(mid):
            r = mid   # keep mid (could be first bad)
        else:
            l = mid + 1
...
Because we want FIRST bad → not just any bad
🎯 Pattern
...
⚠️ Common Mistakes
Using l <= r ❌
Doing r = mid - 1 ❌ (you might skip answer)
Not understanding monotonic pattern ❌
🔥 Interview Tip

Say:
👉 “I’m searching for the first occurrence of True in a monotonic condition”
